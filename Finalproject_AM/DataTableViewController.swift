...
class DataTableViewController: UITableViewController,  NSFetchedResultsControllerDelegate  {
    ...
    var hRect = 8
    var i = 0
    var color = [#colorLiteral(red: 0.7159002205, green: 0.7519180853, blue: 1, alpha: 1),#colorLiteral(red: 0.4880080041, green: 0.4273793394, blue: 0.9386941386, alpha: 1),#colorLiteral(red: 0.2945601255, green: 0.5465806749, blue: 0.9386941386, alpha: 1),#colorLiteral(red: 0.44840756, green: 0.798639889, blue: 0.8748178433, alpha: 1),#colorLiteral(red: 0.2530386865, green: 1, blue: 0.4566036063, alpha: 1),#colorLiteral(red: 0.389306744, green: 0.9335127915, blue: 0.7395909751, alpha: 1),#colorLiteral(red: 0.3095545338, green: 0.5655764249, blue: 0.2324836445, alpha: 1),#colorLiteral(red: 0.606016352, green: 0.9048421637, blue: 0.6626235875, alpha: 1),#colorLiteral(red: 0.05603506451, green: 0.8776109132, blue: 0.07241543163, alpha: 1),#colorLiteral(red: 1, green: 0.9991717456, blue: 0.08143709102, alpha: 1),#colorLiteral(red: 0.954298899, green: 0.6440261048, blue: 0.08306176315, alpha: 1),#colorLiteral(red: 1, green: 0.4767707614, blue: 0.03596805023, alpha: 1),#colorLiteral(red: 1, green: 0.7159523124, blue: 0.5023524784, alpha: 1),#colorLiteral(red: 1, green: 0.4024799991, blue: 0.1427628763, alpha: 1),#colorLiteral(red: 0.9670843909, green: 0.6725604544, blue: 0.7310534835, alpha: 1),#colorLiteral(red: 1, green: 0.39433483, blue: 0.7319310064, alpha: 1),#colorLiteral(red: 0.8471299087, green: 0.6309433598, blue: 1, alpha: 1),#colorLiteral(red: 0.4013591458, green: 0.4290539685, blue: 1, alpha: 1)]
